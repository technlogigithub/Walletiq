        ...
        <div className="bg-[#0C0E11] text-white">
          <div className="grid grid-cols-12 gap-6 ">
            <div className="col-span-12 lg:col-span-6 h-screen flex justify-center items-center ">
              <div className="flex flex-col1 justify-center items-center p-8 w-5/6 zindex-1">
                <div className="w-full login-card  bg-[#16181F] rounded-md">
                  <div className="text-center text-white mt-5">
                    ...
                    <p className="text-2xl font-medium letter-spacing-1px">Login to your account</p>
                  ...
                  <form className="p-6 rounded-lg shadow-md l-form justify-center items-center">
                    ...
                    <div className="mb-6">
                      <label className="block text-[#9197A4] mb-2">Password</label>
                      <input
                        className="w-full p-2 bg-[#1E1F28] text-white rounded fs1p25rem h-10"
                        type="tel"
                        id="password"
                    ...
                    <div className="mt-4 text-sm flex flex-col justify-center items-center">
                      <a href="#" className="cd-grey-col underline" onClick={() => navigate('/reset-password')}>
                        Forgot your password?
                      </a>
                      <a href="#" className="cd-grey-col my-4">
                        Don’t have an account?{" "}
                        <span className="text-[#37CBB0] underline" onClick={() => navigate('/sign-up')}>Sign up here</span>
                      </a>
                    </div>
                  </form>
                </div>
                ...
                /> */}
                  ...
                  {isSmallScreens ? (
                      ...
                      <img
                          src={image}
                          srcSet={image}
                          className="hero-bg-img object-contain relative  z-0  float-right"
                          alt=""
                      />
                  ) : (
                      <img
